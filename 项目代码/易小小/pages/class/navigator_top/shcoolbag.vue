<template>
	...
	<view class="content" style="position: relative;z-index: 3;background-color: #f8f8f8;">
		...
		:scroll-top = "scrolltop" @scroll="scroll_index($event)">
			<view  v-for="(data,index) in resarr" :key="index" >
				<view class="G1_new" style="display: flex;justify-content: space-between;" >
					<view class="G1_new_item" :style="elementstyle" @click="navi_deteial(index)">
						...
						<view style="width: 100%;height: 80px;">
							...
							<view class="moneny" > 
								...
								<label style=" font-size: 20px;"> {{data.oldPrice}}</label>
								<label style="color: #dcdcdc; font-size: 12px;margin-left: 3px;">新品价</label>
								<label style="color: #dcdcdc; font-size: 12px;">{{data.newPrice}}</label>
