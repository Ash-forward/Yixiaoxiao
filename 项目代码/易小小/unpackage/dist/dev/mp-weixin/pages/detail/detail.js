...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    a: $data.Width + "px",
    b: $data.GoodsDataDefault[$data.item].imglink,
    c: $data.Width + "px",
    d: common_vendor.t($data.GoodsDataDefault[$data.item].newPrice),
    e: common_vendor.t($data.GoodsDataDefault[$data.item].oldPrice),
    f: common_vendor.t($data.GoodsDataDefault[$data.item].ifnew),
    g: common_vendor.n($data.GoodsDataDefault[$data.item].ifnew == "\u5168" ? "style1" : $data.GoodsDataDefault[$data.item].ifnew > 80 ? "style2" : $data.GoodsDataDefault[$data.item].ifnew > 70 ? "style3" : $data.GoodsDataDefault[$data.item].ifnew > 50 ? "style4" : "style5"),
    h: common_vendor.t($data.GoodsDataDefault[$data.item].title),
    i: $data.Width + "px",
    j: $data.Width + "px",
    k: $data.Width - 20 + "px",
    l: common_vendor.t($data.GoodsDataDefault[$data.item].cart),
    m: $data.Width + "px",
    n: $data.Width + "px",
    o: common_vendor.o(($event) => $options.preview()),
    p: common_vendor.o(($event) => $options.preview()),
    q: common_vendor.o(($event) => $options.preview()),
    r: common_vendor.o(($event) => $options.preview()),
    s: $data.Width + "px",
    t: common_vendor.p({
      type: "chat",
      size: "30"
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-3e159eb4"], ["__file", "C:/Users/LENOVO/Desktop/\u6613\u7269/\u6613\u7269/pages/detail/detail.vue"]]);
